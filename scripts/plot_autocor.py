...
if __name__ == '__main__':
    ...
    parser.add_argument('-ds', '--dynSpec', action='store_true', help='Plot dynamic spectra')
    parser.add_argument('-ft', '--fluxvstime', action='store_true', help='Plot flux vs time')
    parser.add_argument('-ns', '--normSpec', action='store_true', help='Plot normalized spectra')
